...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/coming_soon.css">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-header p-0">
                                <img src="../assets/images/<?= $movie_detail['photo'];?>" alt="movie_image" class="card-img img-fluid">
                            </div>
