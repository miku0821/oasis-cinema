...
<body>
    ...
    <main>
        ...
        <!-- screening calender -->
        <div class="calender">
            <form action="../actions/movieDetail.php" method="post" class="text-center">
            <?php
            ...
            ?>
                ...
                <button type="submit" name="date" value="<?= date('Y-m-d', strtotime("$i day", $today));?>">
                    <?= date('D m/d', strtotime("$i day", $today));?>
                </button>
        ...
        <table class="table table-borderless" id="time_schedule">
            ...
            <tr class="d-flex">
                ...
                <!-- reservation link -->
                <td class="col-md-2">
                    <a href="ticket.php?schedule_id=<?= $times['schedule_id'];?>&movie_id=<?= $movie_id;?>" class="d-inline"><?= $times['st_time'];?></a>
                </td>
